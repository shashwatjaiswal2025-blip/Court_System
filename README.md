...
i kind of regert using JWT bearer authentication since i could not find the easy way to set it up in postmann and had to manually copy token as needed
